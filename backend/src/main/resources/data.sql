...
DROP TABLE IF EXISTS public.dashboard_message;
...
--
-- Name: dashboard_message; Type: TABLE; Schema: public; Owner: user
--

CREATE TABLE IF NOT EXISTS public.dashboard_message (
                                id bigint NOT NULL,
                                message character varying(2000) NOT NULL,
                                created_at timestamp(6) without time zone NOT NULL
);

ALTER TABLE IF EXISTS ONLY public.dashboard_message OWNER TO "user";

--
-- Name: dashboard_message_id_seq; Type: SEQUENCE; Schema: public; Owner: user
--

ALTER TABLE IF EXISTS ONLY public.dashboard_message ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Data for Name: dashboard_message; Type: TABLE DATA; Schema: public; Owner: user
--

INSERT INTO public.dashboard_message VALUES (1, '{"event_type":"ReviewCreated","study_program":{"universityName":"Slovenská technická univerzita v Bratislave","facultyName":"Fakulta elektrotechniky a informatiky","programName":"aplikovaná informatika"},"program_id":83,"user_id":"ff129217-d4d3-4e53-b8ef-12fe9bad1657"}', '2025-12-12 17:42:27.772174');
INSERT INTO public.dashboard_message VALUES (2, '{"event_type":"ReviewCreated","study_program":{"universityName":"Ekonomická univerzita v Bratislave","facultyName":"Obchodná fakulta","programName":"Tourism Management"},"program_id":57,"user_id":"4f509766-2f3e-49f5-a088-a7a1b6ae5f06"}', '2025-12-12 17:46:27.770256');
INSERT INTO public.dashboard_message VALUES (3, '{"event_type":"ReviewCreated","study_program":{"universityName":"Univerzita Pavla Jozefa Šafárika v Košiciach","facultyName":"Lekárska fakulta","programName":"chirurgia"},"program_id":170,"user_id":"c4f36c3f-96e1-4f8a-a5d3-a2c4a39db7b1"}', '2025-12-12 17:49:03.911241');
