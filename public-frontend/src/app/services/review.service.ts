  ...
  private mockReviews: ReviewModel[] = [
    {
      ...
      semester: 'WINTER',
      overallRating: 8.5,
      teachingQualityRating: 9,
      difficultyRating: 7,
      resourcesRating: 8,
      careerProspectsRating: 10,
      reviewText:
    ...
    },
    {
      ...
      semester: 'FULL_YEAR',
      overallRating: 7.25,
      teachingQualityRating: 8,
      difficultyRating: 8,
      resourcesRating: 6,
      careerProspectsRating: 7,
      reviewText:
    ...
    },
    {
      ...
      semester: 'WINTER',
      overallRating: 6,
      teachingQualityRating: 6,
      difficultyRating: 9,
      resourcesRating: 5,
      careerProspectsRating: 6,
      reviewText:
