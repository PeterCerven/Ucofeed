...
export class ReviewsComponent {
  ...
  // Mock data for variants - will come from backend
  availableVariants = signal<any[]>([
    { id: 1, title: 'Bachelor', studyFormat: 'Full-time', studyDuration: 3 },
    { id: 2, title: 'Master', studyFormat: 'Full-time', studyDuration: 2 },
  ]);
  preselectedVariantId = signal<number | null>(1); // Will come from user's enrollment
